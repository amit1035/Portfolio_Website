...
const Home = () => {
  return (
    <section
      ...
      className="text-white flex flex-col-reverse md:flex-row w-full justify-between items-center md:items-start p-10 md:p-20 gap-10 md:gap-0"
    >
      {/* Left Content */}
      <div className="md:w-1/2 md:pt-10 text-center md:text-left max-w-xl mx-auto md:mx-0">
        ...
        <button
          type="button"
          className="mt-8 text-white py-3 px-6 md:px-8 text-base md:text-lg rounded-3xl bg-indigo-600 hover:bg-indigo-700 transition-all duration-300 hover:scale-105 font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-400"
        >
          Contact Me
        </button>
      </div>
